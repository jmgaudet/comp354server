...
describe('Response class', ()=> {
    ...
    it('should create a json string from a JSON payload', () => {
        ...
        let expected = '{"is_success":true,"message":"This is a response","contents":[{"id":22,"you":"get","the":"point"}]}';
    ...
    it('should create a json string from an empty payload', () => {
        ...
        let expected = '{"is_success":false,"message":"This is a response","contents":[]}';
